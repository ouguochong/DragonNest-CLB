...
namespace game
{
	namespace network
	{
		...
		public:
			...
			void write_string(std::string const& data, std::size_t fixed_size = 0);
			void write_wide_string(std::string const& data, std::size_t fixed_size = 0);
			...
			std::string read_string(std::size_t fixed_size = 0);
			std::string read_wide_string(std::size_t fixed_size = 0);
